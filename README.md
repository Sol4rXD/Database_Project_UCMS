...
ยินดีต้อนรับสู่โปรเจกต์ระบบลงทะเบียนชมรม (Uniclub Management System) โปรเจกต์นี้พัฒนาด้วย **Next.js** และใช้ **Prisma** ในการจัดการฐานข้อมูล โดยมีขั้นตอนการตั้งค่า (Setup) และการทดสอบดังนี้
