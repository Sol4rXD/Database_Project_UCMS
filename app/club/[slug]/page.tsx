        ...
        <main className="bg-[#F5F7FA] text-[#0f2b46]">
            ...
            <section className="max-w-[1180px] mx-auto px-6 pt-10">
                ...
                <div className="w-full h-[420px] relative rounded-3xl overflow-hidden bg-slate-200">
                    <Image
                        src={transformGoogleDriveUrl(club.logo_url)}
                        alt={club.club_name}
                        fill
                        className="object-cover"
                        unoptimized={club.logo_url?.includes('drive.google.com') || club.logo_url?.includes('googleusercontent.com')}
                    />
                </div>
                ...
                <div className="grid grid-cols-3 gap-16 mt-10">
                    ...
                    <div className="col-span-2">
                        ...
                        <div className="mt-12">
                            ...
                            {club.google_map_link ? (
                                <div className="w-[585px] h-[400px] rounded-[15px] overflow-hidden shadow-lg">
                                    <iframe
                                        src={
                                            club.google_map_link
                                                .replace(
                                ...
                                <div className="bg-gray-200 h-[200px] flex items-center justify-center rounded-xl">
                                    {club.location}
                                </div>
                            )}
                        </div>
                            ...
                            >
                                ...
                                <div className="flex gap-1 mb-6 mt-auto">
                                    {[...Array(5)].map((_, starI) => (
                                        <Star
                                            key={starI}
                                            className={`w-4 h-4 ${starI < (review.rating || 5) ? 'fill-[#FBBF24] text-[#FBBF24]' : 'fill-gray-200 text-gray-200'}`}
                                        />
                                    ))}
                                </div>
                                ...
                                <div className="flex items-center gap-2.5">
                                    <div className="w-9 h-9 rounded-full overflow-hidden shrink-0 relative border-1 border-white shadow-sm">
                                        <Image
                                            src={transformGoogleDriveUrl(review.user_image || "/testpic/anonymous.webp")}
                                            alt="avatar"
                                            fill
                                            className="object-cover"
                                            unoptimized={review.user_image?.includes('drive.google.com') || review.user_image?.includes('googleusercontent.com')}
                                        />
                                    </div>
                                    <div className="flex flex-col text-left">
                                        <h5 className="font-bold text-[13px] text-[#111827] leading-tight">{review.name}</h5>
